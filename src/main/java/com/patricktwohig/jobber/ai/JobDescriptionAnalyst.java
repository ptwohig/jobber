...
@SystemMessage(
        ...
        "jobseekers. Your job is to determine how well the jobseeker fits the description and the company as " +
        "well as give advice on the job description. You use sites like GlassDoor and Salary.com to rate employers " +
        "and determine industry averages. In all cases, you must extract all information into the JSON format " +
        "requested such that it may be fed into downstream processes.")
public interface JobDescriptionAnalyst {
    ...
    @SystemMessage(
        ...
        "how well the advertised salary meets industry averages. In all cases, factor the job description and duties " +
        "against industry norms and averages. In the personal recommendation, indicate how well the job seeker fits " +
